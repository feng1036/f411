...
/* Define ********************************************************************/
#ifndef __PRC_REMOTE__
#define __PRC_REMOTE__
...
/* Data memory blocks */
#define DATA_DATA1_BASE                                 (0x20014000U)
...
#define RVM_VIRT_VCT_NUM                                (1U)
/* State block base address & size */
#define RVM_VIRT_STATE_BASE                             (0x200179C0U)
#define RVM_VIRT_STATE_SIZE                             (0x40U)
/* Virtual register base address & size */
#define RVM_VIRT_REG_BASE                               (0x20017950U)
