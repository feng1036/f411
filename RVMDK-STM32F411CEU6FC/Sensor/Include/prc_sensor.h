...
/* Define ********************************************************************/
#ifndef __PRC_SENSOR__
#define __PRC_SENSOR__
...
#define RVM_VIRT_VCT_NUM                                (3U)
/* State block base address & size */
#define RVM_VIRT_STATE_BASE                             (0x200139C0U)
#define RVM_VIRT_STATE_SIZE                             (0x40U)
/* Virtual register base address & size */
#define RVM_VIRT_REG_BASE                               (0x20013950U)
